...
goal = st.text_input( "Goal", placeholder="e.g. Learn conversational Spanish")


col1, col2 = st.columns(2)
with col1:
    timeframe = st.selectbox( "Timeframe", ["MONTHLY", "YEARLY"])
with col2:
...
if st.button("Generate Plan", use_container_width=True):
    ...
    if result["status"] != "success":
        ...
        st.download_button( "Download JSON", data = json.dumps(result["tasks"], indent=4), file_name = "tasks.json", mime = "application/json")